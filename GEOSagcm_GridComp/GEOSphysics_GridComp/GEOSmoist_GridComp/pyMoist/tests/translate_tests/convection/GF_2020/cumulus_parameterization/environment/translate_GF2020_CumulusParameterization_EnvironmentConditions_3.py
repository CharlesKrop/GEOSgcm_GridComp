...
class TranslateGF2020_CumulusParameterization_EnvironmentConditions_3_shallow(
...
class TranslateGF2020_CumulusParameterization_EnvironmentConditions_3_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_EnvironmentConditions_3_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
