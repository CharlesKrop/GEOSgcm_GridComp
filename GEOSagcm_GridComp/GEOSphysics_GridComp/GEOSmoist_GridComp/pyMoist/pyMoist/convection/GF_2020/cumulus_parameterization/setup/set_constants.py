...
def set_constants(
    ...
    if plume == Plumes.SHALLOW.value:
        ...
        plume_dependent_constants.USE_EXCESS = (
            cumulus_parameterization_config.USE_EXCESS_SHALLOW
        )
        plume_dependent_constants.ENTRAINMENT_RATE = (
            cumulus_parameterization_config.ENTRAINMENT_RATE_SHALLOW
        )
        plume_dependent_constants.ENABLE_PLUME = (
        ...
        if PRESSURE_GRADIENT_CONSTANT != 0.0:
            ...
            plume_dependent_constants.LAMBDA_DEEP = (
                cumulus_parameterization_config.LAMBDA_DEEP
            )
            plume_dependent_constants.LAMBDA_DOWN = (
        ...
        # closure choice
        plume_dependent_constants.CLOSURE_CHOICE = (
        ...
        plume_dependent_constants.USE_EXCESS = (
            cumulus_parameterization_config.USE_EXCESS_MID
        )
        plume_dependent_constants.ENTRAINMENT_RATE = (
            cumulus_parameterization_config.ENTRAINMENT_RATE_MID
        )
        plume_dependent_constants.ENABLE_PLUME = (
        ...
        # timescale of cape removal
        plume_dependent_constants.TAU_CAPE_REMOVAL = (
            cumulus_parameterization_config.TAU_MID
        )

        # closure choice
        plume_dependent_constants.CLOSURE_CHOICE = (
            cumulus_parameterization_config.CLOSURE_CHOICE_MID
        )
        ...
        plume_dependent_constants.USE_EXCESS = (
            cumulus_parameterization_config.USE_EXCESS_DEEP
        )
        plume_dependent_constants.ENTRAINMENT_RATE = (
            cumulus_parameterization_config.ENTRAINMENT_RATE_DEEP
        )
        plume_dependent_constants.ENABLE_PLUME = (
        ...
        # temperature for diurnal cycle section
        plume_dependent_constants.T_STAR = Float(
            5.0
        )  # temp scale in original paper = 1 K
        ...
        # closure choice
        plume_dependent_constants.CLOSURE_CHOICE = (
            cumulus_parameterization_config.CLOSURE_CHOICE_DEEP
        )

    else:
        raise NotImplementedError(
            "Unknown plume specified, corresponding constants are unavailable."
        )
