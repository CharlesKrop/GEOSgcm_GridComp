"""
Constants for GFDL_1M Phase Change Loop. Some of these are
duplicated from the generic GFDL constants. Once the GFDL_1M
scheme is finalized, this constant files should be revisited and condensed.
"""
