...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.detrainment_start_level.data[:] = (
            inputs["local_detrainment_start_level"] - 1
        )
...
class TranslateGF2020_CumulusParameterization_DowndraftMassFlux_shallow(
...
class TranslateGF2020_CumulusParameterization_DowndraftMassFlux_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_DowndraftMassFlux_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
