...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_shallow(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_mid(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_deep(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
