...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.normalized_massflux_updraft[:] = inputs[
            "local_normalized_massflux_updraft"
        ]
...
class TranslateGF2020_CumulusParameterization_FirstGuessMoistStaticEnergy_shallow(
...
class TranslateGF2020_CumulusParameterization_FirstGuessMoistStaticEnergy_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_FirstGuessMoistStaticEnergy_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
