...
class TranslateGF2020_CumulusParameterization_GetBuoyancy_2_shallow(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_GetBuoyancy_2_mid(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_GetBuoyancy_2_deep(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        _namelist: Namelist,
