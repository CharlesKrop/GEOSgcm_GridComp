...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.mass_entrainment_downdraft.data[:] = inputs[
            "local_mass_entrainment_downdraft"
        ]
        locals.mass_detrainment_downdraft.data[:] = inputs[
            "local_mass_detrainment_downdraft"
        ]
...
class TranslateGF2020_CumulusParameterization_DowndraftLateralMassFlux_shallow(
...
class TranslateGF2020_CumulusParameterization_DowndraftLateralMassFlux_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_DowndraftLateralMassFlux_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
