...
def calculate_derived_states(
    ...
    with computation(PARALLEL), interval(0, -1):
        ...
        mass = dp / MAPL_GRAV
        mass_inverse = 1 / mass
        sat, dsat = compute_saturation_specific_humidity(t=t, p=p_mb * 100, ese=ese, esx=esx)
        u_unmodified = u
        v_unmodified = v
...
def find_lcl_level(
    ...
    with computation(PARALLEL), interval(-1, None):
        qsat, _ = compute_saturation_specific_humidity(t=t, p=p_mb * 100, ese=ese, esx=esx)
...
def compute_estimated_inversion_strength(
    ...
    with computation(FORWARD), interval(-1, None):
        ...
        t850 = 0.5 * (t + t700)
        qs850, _ = compute_saturation_specific_humidity(t=t850, p=100 * 850, ese=ese, esx=esx)
