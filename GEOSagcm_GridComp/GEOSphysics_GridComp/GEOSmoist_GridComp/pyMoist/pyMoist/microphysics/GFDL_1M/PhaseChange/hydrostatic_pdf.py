...
def hydrostatic_pdf(
    ...
    with computation(PARALLEL), interval(...):
        ...
        t_n = t
        qs_x, _ = compute_saturation_specific_humidity(t=t, p=p_mb * 100, ese=ese, esx=esx)
        ...
        while count <= 20:
            ...
            cf_p = cf_n
            t_p = t_n
            qs_n, dqs = compute_saturation_specific_humidity(t=t_n, p=p_mb * 100, ese=ese, esx=esx)
        ...
        denom, _ = compute_saturation_specific_humidity(t=t, p=p_mb * 100.0, ese=ese, esx=esx)
