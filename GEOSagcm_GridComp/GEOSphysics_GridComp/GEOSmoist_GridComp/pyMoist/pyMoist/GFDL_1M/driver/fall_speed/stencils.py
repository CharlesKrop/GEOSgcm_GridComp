        ...
        if const_vi == True:  # noqa
            ...
            if qi < constants.THI:
                ...
                viLSC = lsc_icefall * 10.0 ** (
                    log10(IWC)
                    * (tc * (constants.AAL * tc + constants.BBL) + constants.CCL)
                    + constants.DDL * tc
                    + constants.EEL
                )
                viCNV = anv_icefall * 10.0 ** (
                    log10(IWC)
                    * (tc * (constants.AAC * tc + constants.BBC) + constants.CCC)
                    + constants.DDC * tc
                    + constants.EEC
                )
                # Combine
        ...
        if const_vs == True:  # noqa
            ...
            if qs < constants.THS:
                ...
                vts = (
                    ...
                    * constants.VCONS
                    * rhof
                    * exp(0.0625 * log(qs * den1 / constants.NORMS))
                )
        ...
        if const_vg == True:  # noqa
            ...
            if qg < constants.THG:
                ...
                vtg = (
                    ...
                    * constants.VCONG
                    * rhof
                    * sqrt(sqrt(sqrt(qg * den1 / constants.NORMG)))
                )
