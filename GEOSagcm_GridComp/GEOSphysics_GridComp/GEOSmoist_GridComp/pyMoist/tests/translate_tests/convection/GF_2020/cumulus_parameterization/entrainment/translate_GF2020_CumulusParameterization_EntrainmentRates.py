...
class TranslateGF2020_CumulusParameterization_EntrainmentRates_shallow(
...
class TranslateGF2020_CumulusParameterization_EntrainmentRates_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_EntrainmentRates_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
