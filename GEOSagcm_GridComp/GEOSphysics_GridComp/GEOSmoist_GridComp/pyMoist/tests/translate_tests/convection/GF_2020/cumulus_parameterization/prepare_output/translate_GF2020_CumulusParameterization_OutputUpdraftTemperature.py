...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        state.output.t_updraft[:, :, :, plume_dependent_constants.PLUME_INDEX] = inputs[
            "t_updraft"
        ]
        ...
        outputs = {
            ...
            "t_updraft": state.output.t_updraft.field[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
        }
...
class TranslateGF2020_CumulusParameterization_OutputUpdraftTemperature_shallow(
...
class TranslateGF2020_CumulusParameterization_OutputUpdraftTemperature_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_OutputUpdraftTemperature_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
