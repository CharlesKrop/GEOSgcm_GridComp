...
class MoistInterface(UserCode):
    ...
    def run_with_internal(
        ...
        self._managed_state.register("cloud_condensates.ice_particle_effective_radius", "RI", internal_repository)
        self._managed_state.register("cloud_condensates.liquid_particle_effective_radius", "RL", internal_repository)
        ...
        self._managed_state.register("tendencies.du_dt_macrophysics", "DUDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.du_dt_microphysics", "DUDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dv_dt_macrophysics", "DVDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dv_dt_microphysics", "DVDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dt_dt_macrophysics", "DTDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dt_dt_microphysics", "DTDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dspecific_humidity_dt_macrophysics", "DQVDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dspecific_humidity_dt_microphysics", "DQVDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dliquid_dt_macrophysics", "DQLDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dliquid_dt_microphysics", "DQLDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dice_dt_macrophysics", "DQIDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dice_dt_microphysics", "DQIDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.drain_dt_macrophysics", "DQRDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.drain_dt_microphysics", "DQRDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dsnow_dt_macrophysics", "DQSDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dsnow_dt_microphysics", "DQSDT_micro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dgraupel_dt", "DQGDT", export_repository)
        self._managed_state.register("tendencies.dgraupel_dt_macrophysics", "DQGDT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dgraupel_dt_microphysics", "DQGDT_micro", export_repository, alloc=MAYBE)
        ...
        self._managed_state.register("tendencies.dtotal_cloud_fraciton_dt_macrophysics", "DQADT_macro", export_repository, alloc=MAYBE)
        self._managed_state.register("tendencies.dtotal_cloud_fraciton_dt_microphysics", "DQADT_micro", export_repository, alloc=MAYBE)
        ...
        # TODO figure out how to allocate only is GFDL1M is turned on
        self._managed_state.register("precipitation_at_surface.falling_graupel", "PRCP_GRAUPEL", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        self._managed_state.register("precipitation_at_surface.falling_ice", "PRCP_ICE", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        self._managed_state.register("precipitation_at_surface.falling_rain", "PRCP_RAIN", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        self._managed_state.register("precipitation_at_surface.falling_snow", "PRCP_SNOW", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        ...
        # TODO figure out how to allocate only is UW is turned on
        self._managed_state.register("precipitation_flux.shallow_convective_rain", "SHLW_PRC3", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        self._managed_state.register("precipitation_flux.shallow_convective_snow", "SHLW_SNO3", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)

        # RadiationState
        # TODO figure out how to allocate only is GFDL1M is turned on
        self._managed_state.register("radiation_state.specific_humidity" "FCLD", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.liquid", "QV", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.ice", "QL", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.rain", "QI", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.graupel", "QR", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.snow", "QS", export_repository, alloc=MAYBE)
        self._managed_state.register("radiation_state.cloud_fraction", "QG", export_repository, alloc=MAYBE)
        ...
        # TODO figure out how to allocate only is GFDL1M is turned on
        self._managed_state.register("microphysics_diagnostics.cloud_liquid_evaporation", "EVAPC", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.cloud_ice_evaporation", "SUBLC", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.relative_humidity_after_pdf", "RHX", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.buoyancy_flux", "WTHV2", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.liquid_water_flux", "WQL", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.hydrostatic_pdf_iterations", "PDFITERS", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.critical_relative_humidity_for_pdf", "RHCRIT", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.large_scale_rainwater_source", "DQRL", export_repository)
        self._managed_state.register("microphysics_diagnostics.nonanvil_large_scale_precipitation_evaporation", "REV_LS", export_repository, alloc=MAYBE)
        self._managed_state.register("microphysics_diagnostics.nonanvil_large_scale_precipitation_sublimation", "RSU_LS", export_repository, alloc=MAYBE)
        ...
        # TODO figure out how to allocate only is GFDL1M is turned on
        self._managed_state.register("diagnostics.lower_tropospheric_stability", "LTS", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
        self._managed_state.register("diagnostics.estimated_inversion_strength", "EIS", export_repository, dims=[I_DIM, J_DIM], alloc=MAYBE)
