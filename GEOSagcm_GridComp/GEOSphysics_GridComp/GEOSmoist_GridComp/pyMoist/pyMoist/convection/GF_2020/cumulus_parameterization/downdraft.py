    ...
    def __init__(self, cumulus_parameterization_config: GF2020CumulusParameterizationConfig):
        if cumulus_parameterization_config.USE_WETBULB == 1:
            raise NotImplementedError(
                "[NDSL] GF2020-->CumulusParameterization-->DowndraftWetBulb: The DowndraftWetBulb"
                "section has not been implemented. You should have been caught before getting"
                "here by the config checker. Beware, something likely failing in the config"
