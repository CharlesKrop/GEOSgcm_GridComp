...
class GF2020Interface(UserCode):
    ...
    def init(self, mapl_state: CVoidPointer, import_state: CVoidPointer, export_state: CVoidPointer):
        ...
        print(f"VALUE RIGHT AFTER MAPL_GET_RESOURCE {gf_2020_env_setting, type(gf_2020_env_setting)}")
        ...
        cumulus_parameterization_config = GF2020CumulusParameterizationConfig(
            ...
            CLOUD_BASE_MASS_FLUX_FACTOR_SHALLOW=Float(maplpy.get_resource(
                "FADJ_MASSFLX_SH:", mapl_state, default=Float(1.0)
            )),
            ...
            USE_LINEAR_SUBCLOUD_MOISTURE_FLUXES=Int(maplpy.get_resource(
                "USE_LINEAR_SUBCL_MF:", mapl_state, default=Int(0)
            )),
        ...
        self._managed_convection_tracers = MAPLManagedState(
            ConvectionTracers.empty(ndsl_stack.quantity_factory, data_dimensions={
    ...
    def run_with_internal(
        ...
        self._managed_state.register("saturation_total_precipitable_water_initial", "TPWI_star", export_repository,dims=[I_DIM, J_DIM], alloc=True)
        ...
        with TimedCUDAProfiler("GF 2020 Convection", {}):
            ...
            with TimedCUDAProfiler("GF 2020 Convection Numerics", {}):
                ...
                self._gf_2020(state=self._managed_state.ndsl_state, convection_tracers=self._managed_convection_tracers)
