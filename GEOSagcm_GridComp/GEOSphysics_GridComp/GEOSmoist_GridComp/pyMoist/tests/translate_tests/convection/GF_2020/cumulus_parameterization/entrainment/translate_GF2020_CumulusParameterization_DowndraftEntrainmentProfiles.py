...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.entrainment_rate_downdraft[:] = inputs[
            "local_entrainment_rate_downdraft"
        ]
        locals.detrainment_function_downdraft[:] = inputs[
            "local_detrainment_function_downdraft"
        ]
...
class TranslateGF2020_CumulusParameterization_DowndraftEntrainmentProfiles_shallow(
...
class TranslateGF2020_CumulusParameterization_DowndraftEntrainmentProfiles_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_DowndraftEntrainmentProfiles_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
