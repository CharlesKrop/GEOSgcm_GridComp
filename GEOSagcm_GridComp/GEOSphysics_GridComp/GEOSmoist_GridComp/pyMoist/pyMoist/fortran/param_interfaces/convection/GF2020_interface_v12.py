...
class GF2020Interface(UserCode):
    ...
    def init(self, mapl_state: CVoidPointer, import_state: CVoidPointer, export_state: CVoidPointer):
        ...
        zero_diff_land = maplpy.get_resource("ZERO_DIFF_LAND:", mapl_state, default=Int(0))
        zero_diff_vvel = maplpy.get_resource("ZERO_DIFF_VVEL:", mapl_state, default=Int(0))
        zero_diff_entr = maplpy.get_resource("ZERO_DIFF_ENTR:", mapl_state, default=Int(0))
        zero_diff_tau = maplpy.get_resource("ZERO_DIFF_TAU:", mapl_state, default=Int(0))
        zero_diff_vgrid = maplpy.get_resource("ZERO_DIFF_VGRID:", mapl_state, default=Int(0))
        zero_diff_other = maplpy.get_resource("ZERO_DIFF_OTHER:", mapl_state, default=Int(0))

        report_negative = maplpy.get_resource("REPORT_GF_NEGATIVE:", mapl_state, default=False)
        ...
        updraft_max_height_ocean_shallow = Float(maplpy.get_resource("HEI_UPDF_OCEAN_SH:", mapl_state, default=Float(0.2)))
        updraft_max_height_ocean_mid = Float(maplpy.get_resource("HEI_UPDF_OCEAN_MD:", mapl_state, default=Float(0.55)))
        updraft_max_height_ocean_deep = Float(maplpy.get_resource("HEI_UPDF_OCEAN_DP:", mapl_state, default=Float(0.55)))
        ...
        minimum_evap_fraction_ocean_mid = Float(maplpy.get_resource("MIN_EDT_OCEAN_MD:", mapl_state, default=Float(0.3)))
        minimum_evap_fraction_ocean_deep = Float(maplpy.get_resource("MIN_EDT_OCEAN_DP:", mapl_state, default=Float(0.3)))
        ...
        self.config = GF2020Config(
            ...
            C1=Float(maplpy.get_resource("C1:", mapl_state, default=Float(1.5e-3))),
        ...
        self.cumulus_parameterization_config = GF2020CumulusParameterizationConfig(
            ...
            C0_MID=Float(maplpy.get_resource("C0_MID:", mapl_state, default=Float(0.5e-3))),
            ...
            SGS_W_TIMESCALE = Int(maplpy.get_resource("SGS_W_TIMESCALE:", mapl_state, default=Int(1.0))),
            ...
            CLOUD_BASE_MASS_FLUX_FACTOR_SHALLOW=Float(maplpy.get_resource("FADJ_MASSFLX_SH:", mapl_state, default=Float(0.5))),
            ...
            MIN_ENTR_RATE = Float(maplpy.get_resource("MIN_ENTR_RATE:", mapl_state, default=Float(0.1e-4))),
            ENTRAINMENT_RATE_DEEP = Float(maplpy.get_resource("ENTR_DP:", mapl_state, default=Float(0.8e-4))),
            ENTRAINMENT_RATE_MID = Float(maplpy.get_resource("ENTR_MD:", mapl_state, default=Float(2.0e-4))),
            ENTRAINMENT_RATE_SHALLOW = Float(maplpy.get_resource("ENTR_SH:", mapl_state, default=Float(6.0e-4))),
            USE_INV_LAYERS = Float(maplpy.get_resource("USE_INV_LAYERS:", mapl_state, default=False)),
            ...
            MOIST_TRIGGER=Int(maplpy.get_resource("MOIST_TRIGGER:", mapl_state, default=Int(1))),
            ...
            AVERAGE_LAYER_DEPTH_SHALLOW=Float(maplpy.get_resource("AVE_LAYER_SH:", mapl_state, default=Float(20.0))),
            AVERAGE_LAYER_DEPTH_MID=Float(maplpy.get_resource("AVE_LAYER_MD:", mapl_state, default=Float(50.0))),
            AVERAGE_LAYER_DEPTH_DEEP=Float(maplpy.get_resource("AVE_LAYER_DP:", mapl_state, default=Float(80.0))),
            ...
            DOWNDRAFT=Int(maplpy.get_resource("DOWNDRAFT:", mapl_state, default=True)),
            ...
            CAP_MAXS_DP=Float(maplpy.get_resource("CAP_MAXS_DP:", mapl_state, default=Float(150.0))),
            CAP_MAXS_SH=Float(maplpy.get_resource("CAP_MAXS_SH:", mapl_state, default=Float(50.0))),
            CAP_MAXS_MD=Float(maplpy.get_resource("CAP_MAXS_MD:", mapl_state, default=Float(150.0))),
    ...
    def run_with_internal(
        ...
        self._managed_state.register("NACTL", "NACTL", internal_repository)
        ...
        self._managed_state.register("TAU_DP", "TAU_DP", export_repository, dims=[I_DIM, J_DIM], alloc=True)
        self._managed_state.register("TAU_MD", "TAU_MD", export_repository, dims=[I_DIM, J_DIM], alloc=True)
        self._managed_state.register(
        ...
        self._managed_state.register("SGS_VVEL_DP", "SGS_VVEL_DP", export_repository, alloc=True)
        self._managed_state.register("SGS_VVEL_MD", "SGS_VVEL_MD", export_repository, alloc=True)
        self._managed_state.register("SGS_VVEL_SH", "SGS_VVEL_SH", export_repository, alloc=True)
        self._managed_state.register(
        ...
        self._managed_state.register("CCWP", "CCWP", export_repository, dims=[I_DIM, J_DIM])

        self._managed_state.register("output.DQVDT_FILL", "DQVDT_FILL_DC", export_repository)
        self._managed_state.register("output.DQLLSDT_FILL", "DQLLSDT_FILL_DC", export_repository)
        self._managed_state.register("output.DQLCNDT_FILL", "DQLCNDT_FILL_DC", export_repository)
        self._managed_state.register("output.DQILSDT_FILL", "DQILSDT_FILL_DC", export_repository)
        self._managed_state.register("output.DQICNDT_FILL", "DQICNDT_FILL_DC", export_repository)
