...
class GF2020Interface(UserCode):
    ...
    def init(self, mapl_state: CVoidPointer, import_state: CVoidPointer, export_state: CVoidPointer):
        ...
        cumulus_parameterization_config = GF2020CumulusParameterizationConfig(
            ...
            USE_EXCESS_MID=maplpy.get_resource("USE_EXCESS_MD:", mapl_state, default=2),
            USE_EXCESS_DEEP=maplpy.get_resource("USE_EXCESS_DP:", mapl_state, default=2),
            AVERAGE_LAYER_DEPTH_SHALLOW=maplpy.get_resource("AVE_LAYER_SH:", mapl_state, default=30.0),
            AVERAGE_LAYER_DEPTH_MID=maplpy.get_resource("AVE_LAYER_MD:", mapl_state, default=40.0),
            AVERAGE_LAYER_DEPTH_DEEP=maplpy.get_resource("AVE_LAYER_DP:", mapl_state, default=40.0),
            ENABLE_SHALLOW=maplpy.get_resource("SHALLOW:", mapl_state, default=0),
            ENABLE_MID=maplpy.get_resource("CONGESTUS:", mapl_state, default=1),
            ENABLE_DEEP=maplpy.get_resource("DEEP:", mapl_state, default=1),
            ENTRAINMENT_RATE_SHALLOW=maplpy.get_resource("ENTR_SH:", mapl_state, default=1.0e-4),
            ENTRAINMENT_RATE_MID=maplpy.get_resource("ENTR_MD:", mapl_state, default=1.0e-4),
            ENTRAINMENT_RATE_DEEP=maplpy.get_resource("ENTR_DP:", mapl_state, default=1.0e-4),
            C0_SHAL=maplpy.get_resource("C0_SHAL:", mapl_state, default=0.0),
            C0_MID=maplpy.get_resource("C0_MID:", mapl_state, default=2.0e-3),
            C0_DEEP=maplpy.get_resource("C0_DEEP:", mapl_state, default=2.0e-3),
            TAU_MID=maplpy.get_resource("TAU_MID:", mapl_state, default=3600),
            TAU_DEEP=maplpy.get_resource("TAU_DEEP:", mapl_state, default=5400),
            CLOSURE_CHOICE_SHALLOW=maplpy.get_resource("CLOSURE_SHALLOW:", mapl_state, default=7),
            ...
            LAMBDA_SHALLOW_DOWN=maplpy.get_resource("LAMBAU_SHDN:", mapl_state, default=2.0),
            CAP_MAXS=maplpy.get_resource("CAP_MAXS:", mapl_state, default=250.0),
            OUTPUT_SOUNDING=maplpy.get_resource("OUTPUT_SOUND:", mapl_state, default=0),
            USE_SCALE_DEP=maplpy.get_resource("USE_SCALE_DEP:", mapl_state, default=1),
            SATURATION_CALCULATION_CHOICE=maplpy.get_resource("SATUR_CALC:", mapl_state, default=1),
            CLOUD_LEVEL_GRID=maplpy.get_resource("CLEV_GRID:", mapl_state, default=1),
            FRAC_MODIS=maplpy.get_resource("FRAC_MODIS:", mapl_state, default=1),
            BOUNDARY_CONDITION_METHOD=maplpy.get_resource("BC_METH:", mapl_state, default=1),
            OVERSHOOT=maplpy.get_resource("OVERSHOOT:", mapl_state, default=0.0),
            USE_MEMORY=maplpy.get_resource("USE_MEMORY:", mapl_state, default=-1),
            ...
            EVAP_FIX=maplpy.get_resource("EVAP_FIX:", mapl_state, default=1),
            SGS_W_TIMESCALE=sgs_w_timescale,
            VERTICAL_DISCRETIZATION_OPTION=maplpy.get_resource("VERT_DISCR:", mapl_state, default=1),
            ALP1=maplpy.get_resource("ALP1:", mapl_state, default=1.0),
            USE_FCT=maplpy.get_resource("USE_FCT:", mapl_state, default=0),
            MIN_ENTRAINMENT_RATE=min_entrainment_rate,
            USE_SMOOTH_TENDENCIES=maplpy.get_resource("USE_SMOOTH_TEND:", mapl_state, default=1),
            USE_RAIN_EVAP_BELOW_CLOUD_BASE=maplpy.get_resource("USE_REBCB:", mapl_state, default=1),
            USE_CLOUD_DISSIPATION=maplpy.get_resource("USE_CLOUD_DISSIPATION:", mapl_state, default=1.0),
            LIGHTNING_DIAGNOSTICS=maplpy.get_resource("LIGHTNING_DIAG:", mapl_state, default=0),
            USE_TRACER_SCAVENGE=maplpy.get_resource("USE_TRACER_SCAVEN:", mapl_state, default=1),
            USE_TRACER_EVAPORATION=maplpy.get_resource("USE_TRACER_EVAP:", mapl_state, default=1),
            USE_FLUX_FORM=maplpy.get_resource("USE_FLUX_FORM:", mapl_state, default=1),
            USE_FCT=maplpy.get_resource("USE_FCT:", mapl_state, default=0),
            MAX_TEMP_VAPOR_TENDENCY=maplpy.get_resource("MAX_TQ_TEND:", mapl_state, default=100.0),
        )
