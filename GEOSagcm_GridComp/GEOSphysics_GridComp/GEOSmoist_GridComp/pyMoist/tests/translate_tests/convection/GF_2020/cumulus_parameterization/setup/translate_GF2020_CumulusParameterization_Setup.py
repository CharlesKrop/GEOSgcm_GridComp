...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume_idx: int, **inputs):
        ...
        outputs = {
            ...
            "scale_dependence_factor": state.output.scale_dependence_factor.field[:, :, plume_idx],
