...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.u_c[:] = inputs["local_u_c"]
        locals.v_c[:] = inputs["local_v_c"]
        locals.u_c_downdraft[:] = inputs["local_u_c_downdraft"]
        locals.v_c_downdraft[:] = inputs["local_v_c_downdraft"]
        locals.cloud_moist_static_energy_forced[:] = inputs[
            "local_cloud_moist_static_energy_forced"
        ]
        locals.cloud_moist_static_energy_downdraft_forced[:] = inputs[
            "local_cloud_moist_static_energy_downdraft_forced"
        ]
        locals.environment_moist_static_energy_cloud_levels_forced[:] = inputs[
            "local_env_moist_static_energy_cloud_levels_forced"
        ]
        locals.vapor_cloud_levels_forced[:] = inputs["local_vapor_cloud_levels_forced"]
        locals.cloud_total_water_after_entrainment_forced[:] = inputs[
            "local_cloud_total_water_after_entrainment_forced"
        ]
        locals.cloud_total_water_after_entrainment_downdraft_forced[:] = inputs[
            "local_cloud_total_water_after_entrainment_downdraft_forced"
        ]
        state.output.cloud_liquid_after_rain_forced[
            :, :, :, plume_dependent_constants.PLUME_INDEX
        ] = inputs["cloud_liquid_after_rain_forced"]
        state.output.condensate_to_fall_forced[
            :, :, :, plume_dependent_constants.PLUME_INDEX
        ] = inputs["condensate_to_fall_forced"]
        ...
        locals.d_buoyancy_downdraft_forced[:] = inputs[
            "local_d_buoyancy_downdraft_forced"
        ]
        ...
        locals.del_moist_static_energy_cloud_ensemble[:] = inputs[
            "local_del_moist_static_energy_cloud_ensemble"
        ]
        ...
        locals.moist_static_energy_tendency_from_environmental_subsidence[:] = inputs[
            "local_moist_static_energy_tendency_from_environmental_subsidence"
        ]
        locals.vapor_tendency_from_environmental_subsidence[:] = inputs[
            "local_vapor_tendency_from_environmental_subsidence"
        ]
        locals.t_tendency_from_environmental_subsidence[:] = inputs[
            "local_t_tendency_from_environmental_subsidence"
        ]
...
class TranslateGF2020_CumulusParameterization_VerticalDiscretization_shallow(
...
class TranslateGF2020_CumulusParameterization_VerticalDiscretization_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_VerticalDiscretization_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
