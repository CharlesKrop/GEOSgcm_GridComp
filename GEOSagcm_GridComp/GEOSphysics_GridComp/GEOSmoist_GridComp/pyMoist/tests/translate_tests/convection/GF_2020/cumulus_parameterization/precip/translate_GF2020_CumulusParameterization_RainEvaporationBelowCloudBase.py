...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.environment_saturation_mixing_ratio_cloud_levels[:] = inputs[
            "local_env_saturation_mixing_ratio_cloud_levels"
        ]
        ...
        locals.evaporation_below_cloud_base[:] = inputs[
            "local_evaporation_below_cloud_base"
        ]
...
class TranslateGF2020_CumulusParameterization_RainEvaporationBelowCloudBase_shallow(
...
class TranslateGF2020_CumulusParameterization_RainEvaporationBelowCloudBase_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_RainEvaporationBelowCloudBase_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
