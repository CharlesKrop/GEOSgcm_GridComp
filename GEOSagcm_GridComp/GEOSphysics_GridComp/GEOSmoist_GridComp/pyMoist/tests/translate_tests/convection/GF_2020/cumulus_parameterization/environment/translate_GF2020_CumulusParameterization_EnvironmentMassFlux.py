...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_shallow(
...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_EnvironmentMassFlux_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
