...
class TranslateGF2020_CumulusParameterization_DowndraftOriginLevel_shallow(
...
class TranslateGF2020_CumulusParameterization_DowndraftOriginLevel_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_DowndraftOriginLevel_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
