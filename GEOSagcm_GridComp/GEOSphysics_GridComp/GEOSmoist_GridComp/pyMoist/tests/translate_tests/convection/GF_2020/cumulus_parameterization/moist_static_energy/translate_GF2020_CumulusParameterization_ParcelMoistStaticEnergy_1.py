...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_1_shallow(
...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_1_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_1_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
