...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.moist_static_energy_origin_level[:] = inputs[
            "local_moist_static_energy_origin_level"
        ]
        ...
        if plume_dependent_constants.ENABLE_PLUME == 1:
            code(
                ...
                environment_moist_static_energy_forced=locals.environment_moist_static_energy_cloud_levels_forced,
...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_2_shallow(
...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_2_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_ParcelMoistStaticEnergy_2_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
