...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        state.output.evaporation_sublimation_tendency[:] = inputs[
            "evaporation_sublimation_tendency"
        ]
...
class TranslateGF2020_CumulusParameterization_TotalEvaporationFlux_shallow(
...
class TranslateGF2020_CumulusParameterization_TotalEvaporationFlux_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_TotalEvaporationFlux_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
