...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        state.output.kstabm[:, :, plume_dependent_constants.PLUME_INDEX] = (
            inputs["kstabm"] - 1
        )
        state.output.kstabi[:, :, plume_dependent_constants.PLUME_INDEX] = (
            inputs["kstabi"] - 1
        )
        ...
        outputs = {
            ...
            + 1,
            "kstabm": state.output.kstabm.field[
                :, :, plume_dependent_constants.PLUME_INDEX
            ]
            + 1,
            "kstabi": state.output.kstabi.field[
                :, :, plume_dependent_constants.PLUME_INDEX
            ]
            + 1,
        }
...
class TranslateGF2020_CumulusParameterization_StableDetrainment_shallow(
...
class TranslateGF2020_CumulusParameterization_StableDetrainment_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_StableDetrainment_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
