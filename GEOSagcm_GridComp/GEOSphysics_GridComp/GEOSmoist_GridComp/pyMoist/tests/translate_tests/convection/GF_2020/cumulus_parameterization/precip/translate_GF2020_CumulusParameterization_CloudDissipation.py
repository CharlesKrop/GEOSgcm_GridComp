...
class TranslateGF2020_CumulusParameterization_CloudDissipation_shallow(
...
class TranslateGF2020_CumulusParameterization_CloudDissipation_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_CloudDissipation_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
