...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.detrainment_function_updraft[:] = inputs[
            "local_detrainment_function_updraft"
        ]
...
class TranslateGF2020_CumulusParameterization_UpdraftVerticalVelocity_shallow(
...
class TranslateGF2020_CumulusParameterization_UpdraftVerticalVelocity_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_UpdraftVerticalVelocity_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
