...
class TranslateGF2020_CumulusParameterization_PrepareOutput_shallow(
...
class TranslateGF2020_CumulusParameterization_PrepareOutput_mid(
    TranslateFortranData2Py
):
    def __init__(
        self,
...
class TranslateGF2020_CumulusParameterization_PrepareOutput_deep(
    TranslateFortranData2Py
):
    def __init__(
        self,
